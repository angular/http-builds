...
/** @nocollapse */ XHRBackend.ngInjectableDef = i0.defineInjectable({ token: XHRBackend, factory: function XHRBackend_Factory(t) { return new (t || XHRBackend)(i0.inject(i1.BrowserXhr), i0.inject(i2.ResponseOptions), i0.inject(i3.XSRFStrategy)); }, providedIn: null });
