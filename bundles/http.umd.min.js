...
/**
     ...
     */
var p,c,l,d,h,f=function(){function e(){}return e.prototype.build=function(){return new XMLHttpRequest},a([t.Injectable(),i("design:paramtypes",[])],e)}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function Z(){return new D}function ee(e,t){return new $(e,t)}function te(e,t){return new W(e,t)}var ne=function(){return a([t.NgModule({providers:[{provide:$,useFactory:ee,deps:[H,J]},f,{provide:J,useClass:U},{provide:m,useClass:b},H,{provide:_,useFactory:Z}]})],function e(){})}(),re=function(){return a([t.NgModule({providers:[{provide:W,useFactory:te,deps:[j,J]},N,{provide:J,useClass:U},{provide:m,useClass:b},j]})],function e(){})}(),oe=new t.Version("6.1.0-beta.3+113.sha-97277bc");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.BrowserXhr=f,e.JSONPBackend=j,e.JSONPConnection=L,e.CookieXSRFStrategy=D,e.XHRBackend=H,e.XHRConnection=k,e.BaseRequestOptions=U,e.RequestOptions=J,e.BaseResponseOptions=b,e.ResponseOptions=m,e.Headers=y,e.Http=$,e.Jsonp=W,e.HttpModule=ne,e.JsonpModule=re,e.Connection=R,e.ConnectionBackend=g,e.XSRFStrategy=_,e.Request=X,e.Response=A,e.QueryEncoder=O,e.URLSearchParams=C,e.VERSION=oe,Object.defineProperty(e,"__esModule",{value:!0})});